...
public class StickerContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        final String authority = WhatsappstickerApiPlugin.getContentProviderAuthority(this.getContext());
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (matchCode) {
            case METADATA_CODE:
                return "vnd.android.cursor.dir/vnd." + WhatsappstickerApiPlugin.getContentProviderAuthority(Objects.requireNonNull(getContext())) + "." + METADATA;
            case METADATA_CODE_FOR_SINGLE_PACK:
                return "vnd.android.cursor.item/vnd." + WhatsappstickerApiPlugin.getContentProviderAuthority(Objects.requireNonNull(getContext())) + "." + METADATA;
            case STICKERS_CODE:
                return "vnd.android.cursor.dir/vnd." + WhatsappstickerApiPlugin.getContentProviderAuthority(Objects.requireNonNull(getContext())) + "." + STICKERS;
    ...
    private synchronized void readContentFile(@NonNull Context context) {
        ...
        stickerPackList.addAll(Stash.<StickerPack>getArrayList("sticker_pack", StickerPack.class));
    }
